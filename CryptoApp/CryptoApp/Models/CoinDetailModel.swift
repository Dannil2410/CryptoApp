...
/*
 ...
 JSON response:
 {
   ...
   "sentiment_votes_up_percentage": 85.34,
   "sentiment_votes_down_percentage": 14.66,
   "watchlist_portfolio_users": 1361323,
   "market_cap_rank": 1,
   "coingecko_rank": 1,
   ...
   "status_updates": [],
   "last_updated": "2023-11-02T10:06:31.481Z"
 }
*/
...
struct CoinDetailModel: Decodable {
    ...
    static let blankObject = CoinDetailModel(
        id: "",
        symbol: "",
        name: "",
